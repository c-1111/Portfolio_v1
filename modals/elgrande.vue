    ...
    <div ref="modalRef" class="project_cont">
      <div class="project_top">
        <div class="left">
          ...
          <div class="project_bio font_body_md">Diseño y desarrollo de las aplicaciones de una marca ficticia dentro de la temática "camiones" en el marco de un trabajo universitario centrado en la producción gráfica, artes finales y acabados. El proyecto consta de; una publicación editorial, un desplegable de envolvente, dos piezas textiles, pegatinas, dos diseños de llaveros, dos carteles en formato A1, </div>
        </div>
        <div class="right">
      ...
      <div class="text_mobile hidden">
        <div class="text_mobile_top">
          ...
          <div class="text_top_right">
            <p class="home_info_txt info_gray text-sm text-[#bebebe]">Desarrollo de identidad y aplicaciones de una marca ficticia como temática elegida en el marco de un trabajo universitario centrado en la producción gráfica, artes finales y acabados.</p>
