<template>
  <MModal>
    <div ref="modalRef">
      <div class="project_top w-full items-center flex">
        <div class="project_presentation">
          <!-- <div class="project_title title_proj">Faux</div> -->
          <div class="text_holder">
            <div class="project_bio inline-block font_body_md">
              <span class="bg-white">Proyecto universitario de obligada temática social. Se abordan las fake news y su
                distribución en el medio digital, la inteligencia artificial para generación de texto e imagen y el
                ruido en
                internet. Se trabaja sobre la estética de la veracidad explorando los noticieros digitales más
                visitados.
                El proyecto propone un generador de noticias falsas en el que el usuario es responsable del suceso.
                El proyecto aborda la identidad visual, el diseño y programación web y el diseño promocional. El
                resultado final
                consta de una identidad de marca, una campaña publicitaria, un noticiero digital, una web explicativa y
                una
                publicación editorial.</span>
            </div>
            <div class="text_video_holder annotation mt-2">
              <span class=" bg-white">A través de una API integrada con un modelo de IA para generación
                de imagen y texto se formula de forma aleatoria un prompt en base a unas reglas predefinidas y se
                devuelve
                a la web un artículo con titular, cuerpo de noticia, autoría, fecha e imagen. </span>
            </div>
          </div>
        </div>
        <div class="big_logo_holder">
          <svg xmlns="http://www.w3.org/2000/svg" width="363" height="174" fill="none" viewBox="0 0 363 174">
            ...
            <defs>
              <clipPath id="a">
                <path fill="#fff" d="M0 0h363v174H0z" />
              </clipPath>
            </defs>
          </svg>
        </div>
      ...
      <div class="project_media">
        <div class="video_slot_left">
          <div class="media">
            <div class="noti">
              <div class="video video_noticiario">
                <video autoplay loop muted src="/public/img/faux/video_web_noticiario.mp4"></video>
              </div>
              <a href="https://faux-noticiario.netlify.app/" class="link" target="_blank"><svg
            ...
            <div class="site">
              <div class="video video_site">
                <video autoplay loop muted src="/public/img/faux/video_web_site.mp4"></video>
              </div>
              <a href="https://faux-site.netlify.app/" class="link" target="_blank"><svg
                  xmlns="http://www.w3.org/2000/svg" width="23" height="9" fill="none" viewBox="0 0 23 9">
                  <path
                    d="M15.655 8.656v-2h3a2 2 0 1 0 0-4h-6a2 2 0 0 0-2 2h-2a4 4 0 0 1 4-4h6a4 4 0 1 1 0 8h-3Zm-8-8v2h-3a2 2 0 1 0 0 4h6a2 2 0 0 0 2-2h2a3.999 3.999 0 0 1-4 4H4.656a4 4 0 0 1 0-8h3Z"
                    clip-rule="evenodd" />
        ...
        <div class="video_slot_center">
          <!-- <img src="/public/img/faux/faux_libro_2.gif" @click="openLightbox(index)"></img> -->
          <div class="image-box">
            <img :src="faux_images[currentImage]" alt="Rotating Image" />
          </div>
        </div>
        <div class="video_slot_right">
          <video autoplay loop muted src="/public/img/faux/video_mupis_blanco.mp4" @click="openLightbox(index)"></video>
        </div>
      </div>
    </div>
    
    <!-- <iframe src="https://faux-noticiario.netlify.app/"></iframe> -->
    <!-- <img draggable="false" src="/public/img/faux/popups/danger.png" alt=""> -->
...
.project_media
  display: grid
  grid-template-columns: auto, 1fr, 1fr  // Crea 3 columnas de igual tamaño
  width: 100%  // Asegura que el grid ocupe todo el ancho disponible
  padding-top: 4rem
  grid-auto-flow: column  // Fuerza que todas las columnas estén en una fila
  ...
  .video_slot_right
    ...
    video
     width: 20vw  
     transform: scale(.94) // Escala el elemento al 120% de su tamaño original
