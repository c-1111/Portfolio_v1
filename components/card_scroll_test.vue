<template>
    <div>
      ...
      <NuxtLink :to="page">
        <div 
          :id="'project_card_' + id" 
          class="project_card flex flex-col w-[22vw] h-[30.5vh] font_body_md_gris">
          ...
          <div 
            ...
            <div 
              class="project_image absolute inset-0 bg-contain bg-center transition-opacity duration-100"
  ...
  @media (min-width: 641px) {
    ...
    .project_card:hover .project_image {
      opacity: 1;  /* Aquí se activa el hover */
    }
  }
  </style>
